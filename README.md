...
| `OWNER_ID` | User ID of the primary owner | `5311223486` |
| `OWNER_USERNAME` | Username of the owner (without `@`) | `moh_maya_official` |
| `SUPPORT_GRP` | Username of the support group | `tmm_support_chat` |
| `UPDATE_CHNL` | Username of the update channel | `frozentools` |
...
- **Support Group:** [Join Chat](https://t.me/tmm_support_chat)
- **News Channel:** [Subscribe](https://t.me/FROZENTOOLS)
